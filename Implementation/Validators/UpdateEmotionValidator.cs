...
{
    public class UpdateEmotionValidator : AbstractValidator<EditEmotionDto>
    {
        public UpdateEmotionValidator(Asp2023DbContext context)
        {
            RuleLevelCascadeMode = CascadeMode.Stop;

            RuleFor(x => x.NewNameEmotion).NotEmpty().WithMessage("Ime je obavezno polje.")
            ...
            RuleFor(x => x.NewImagePath).NotEmpty().WithMessage("Putanja je obavezno polje.")
